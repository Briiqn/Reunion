...
@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 152, supports = {39, 78})
public final class ConsoleDebugOptionsC2SPacket extends ConsoleC2SPacket {

  private int uiVal;

  public ConsoleDebugOptionsC2SPacket() {
  }
