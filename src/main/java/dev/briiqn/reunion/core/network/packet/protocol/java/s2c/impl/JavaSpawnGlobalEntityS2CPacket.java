...
@PacketInfo(side = PacketSide.JAVA_S2C, id = 0x2C, supports = {47})
public final class JavaSpawnGlobalEntityS2CPacket extends JavaS2CPacket {

  private int entityId;
  private byte type;
  private int x, y, z;

  public JavaSpawnGlobalEntityS2CPacket() {
  }
  ...
  public void handle(JavaSession session) {
    ...
    em.registerCategory(entityId,
        dev.briiqn.reunion.core.manager.EntityManager.EntityCategory.GLOBAL_ENTITY);
    em.setExtraData(entityId, type); // type is a Byte
    ...
    PacketManager.sendToConsole(cs,
        new ConsoleAddGlobalEntityS2CPacket(cid, type, cx, y, cz));
  }
}