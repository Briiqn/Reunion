...
import dev.briiqn.reunion.core.network.packet.protocol.java.c2s.impl.JavaCreativeInventoryActionC2SPacket;
import dev.briiqn.reunion.core.session.ConsoleSession;
import io.netty.buffer.ByteBuf;

@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 107, supports = {39, 78})
public final class ConsoleSetCreativeModeSlotC2SPacket extends ConsoleC2SPacket {

  private short slot;
  private ItemInstance item;

  public ConsoleSetCreativeModeSlotC2SPacket() {
  }
  ...
  public void handle(ConsoleSession session) {
    PacketManager.sendToJava(session.getJavaSession(),
        new JavaCreativeInventoryActionC2SPacket(slot, item));
  }
}
