...
@PacketInfo(side = PacketSide.CONSOLE_S2C, id = 5, supports = {39, 78})
public final class ConsoleSetEquippedItemS2CPacket extends ConsoleS2CPacket {

  private final int consoleEntityId;
  private final short slot;
  private final ItemInstance item;

  public ConsoleSetEquippedItemS2CPacket() {
    this(0, (short) 0, null);
  }

  public ConsoleSetEquippedItemS2CPacket(int consoleEntityId, short slot, ItemInstance item) {
