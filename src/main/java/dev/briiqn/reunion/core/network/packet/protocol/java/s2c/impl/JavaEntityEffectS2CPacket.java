...
import dev.briiqn.reunion.core.network.packet.protocol.console.s2c.impl.ConsoleUpdateMobEffectS2CPacket;
...
@PacketInfo(side = PacketSide.JAVA_S2C, id = 0x1D, supports = {47})
public final class JavaEntityEffectS2CPacket extends JavaS2CPacket {

  private int entityId;
  private byte effectId, amplifier;
  private int duration;

  public JavaEntityEffectS2CPacket() {
  }
  ...
  public void handle(JavaSession session) {
    ...
    short d = (short) Math.min(duration, 32767);
    PacketManager.sendToConsole(session.getConsoleSession(),
        new ConsoleUpdateMobEffectS2CPacket(cid, effectId, amplifier, d));
  }
}