...
@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 103, supports = {39, 78})
public final class ConsoleContainerSetSlotC2SPacket extends ConsoleC2SPacket {

  public ConsoleContainerSetSlotC2SPacket() {
  }

  @Override
  public void read(ByteBuf buf) {
    buf.readByte(); // containerId
    buf.readShort(); // slot
    ItemUtil.readConsoleItem(buf); // item
  }
