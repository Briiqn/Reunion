...
@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 255, supports = {39, 78})
public final class ConsoleDisconnectC2SPacket extends ConsoleC2SPacket {

  private DisconnectReason reason;

  public ConsoleDisconnectC2SPacket() {
  }

  @Override
  public void read(ByteBuf buf) {
    reason = DisconnectReason.fromId(buf.readInt());
  }
  ...
  public void handle(ConsoleSession session) {
    if (session.getConsoleChannel() != null) {
