...
@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 16, supports = {39, 78})
public final class ConsoleSetCarriedItemC2SPacket extends ConsoleC2SPacket {

  private short slot;

  public ConsoleSetCarriedItemC2SPacket() {
  }
  ...
  public void handle(ConsoleSession session) {
    ...
    session.setHeldItemSlot(slot & 0xFF);

    PacketManager.sendToJava(session.getJavaSession(), new JavaHeldItemChangeC2SPacket(slot));
  }
}
