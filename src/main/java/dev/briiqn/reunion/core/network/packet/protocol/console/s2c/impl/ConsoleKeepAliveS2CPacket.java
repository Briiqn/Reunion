...
@PacketInfo(side = PacketSide.CONSOLE_S2C, id = 0, supports = {39, 78})
public final class ConsoleKeepAliveS2CPacket extends ConsoleS2CPacket {

  private final int keepAliveId;

  public ConsoleKeepAliveS2CPacket() {
    this(0);
  }

  public ConsoleKeepAliveS2CPacket(int keepAliveId) {
