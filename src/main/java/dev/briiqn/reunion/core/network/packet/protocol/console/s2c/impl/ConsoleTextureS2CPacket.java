...
@PacketInfo(side = PacketSide.CONSOLE_S2C, id = 154, supports = {39, 78})
public final class ConsoleTextureS2CPacket extends ConsoleS2CPacket {

  private final String textureName;
  private final byte[] data;

  public ConsoleTextureS2CPacket() {
    this("", new byte[0]);
  }

  public ConsoleTextureS2CPacket(String textureName, byte[] data) {
