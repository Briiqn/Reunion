...
@PacketInfo(side = PacketSide.JAVA_S2C, id = 0x19, supports = {47})
public final class JavaEntityHeadLookS2CPacket extends JavaS2CPacket {

  private int entityId;
  private byte headYaw;

  public JavaEntityHeadLookS2CPacket() {
  }
  ...
  public void handle(JavaSession session) {
    ...
    PacketManager.sendToConsole(session.getConsoleSession(),
        new ConsoleRotateHeadS2CPacket(cid, headYaw));
  }
}