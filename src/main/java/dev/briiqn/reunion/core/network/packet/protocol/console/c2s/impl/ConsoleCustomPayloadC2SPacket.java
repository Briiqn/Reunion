...
@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 250, supports = {39, 78})
public final class ConsoleCustomPayloadC2SPacket extends ConsoleC2SPacket {

  public ConsoleCustomPayloadC2SPacket() {
  }

  @Override
  public void read(ByteBuf buf) {
    StringUtil.readConsoleUtf(buf);
