...
import dev.briiqn.reunion.core.network.packet.protocol.console.s2c.impl.ConsoleRemoveMobEffectS2CPacket;
...
@PacketInfo(side = PacketSide.JAVA_S2C, id = 0x1E, supports = {47})
public final class JavaRemoveEntityEffectS2CPacket extends JavaS2CPacket {

  private int entityId;
  private byte effectId;

  public JavaRemoveEntityEffectS2CPacket() {
  }
  ...
  public void handle(JavaSession session) {
    ...
    PacketManager.sendToConsole(session.getConsoleSession(),
        new ConsoleRemoveMobEffectS2CPacket(cid, effectId));
  }
}