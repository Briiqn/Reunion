...
import dev.briiqn.reunion.core.network.packet.protocol.java.c2s.impl.JavaUpdateSignC2SPacket;
import dev.briiqn.reunion.core.session.ConsoleSession;
import dev.briiqn.reunion.core.util.StringUtil;
import io.netty.buffer.ByteBuf;

@PacketInfo(side = PacketSide.CONSOLE_C2S, id = 130, supports = {39, 78})
public final class ConsoleSignUpdateC2SPacket extends ConsoleC2SPacket {

  private final String[] lines = new String[4];
  private int x, y, z;

  public ConsoleSignUpdateC2SPacket() {
  }
  ...
  public void read(ByteBuf buf) {
    ...
    for (int i = 0; i < 4; i++) {
      lines[i] = StringUtil.readConsoleUtf(buf);
    }
  }
  ...
  public void handle(ConsoleSession session) {
    ...
    PacketManager.sendToJava(session.getJavaSession(),
        new JavaUpdateSignC2SPacket(javaX, y, javaZ, lines));
  }
}