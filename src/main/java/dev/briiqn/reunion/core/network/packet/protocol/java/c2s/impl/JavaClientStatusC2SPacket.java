...
@PacketInfo(side = PacketSide.JAVA_C2S, id = 0x16, supports = {47})
public final class JavaClientStatusC2SPacket extends JavaC2SPacket {

  private final int action;

  public JavaClientStatusC2SPacket() {
    this(0);
  }

  public JavaClientStatusC2SPacket(int action) {
    this.action = action;
  }
