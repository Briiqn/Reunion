...
@PacketInfo(side = PacketSide.CONSOLE_S2C, id = 255, supports = {39, 78})
public final class ConsoleDisconnectS2CPacket extends ConsoleS2CPacket {

  private final DisconnectReason reason;

  public ConsoleDisconnectS2CPacket() {
    this(DisconnectReason.NONE);
  }

  public ConsoleDisconnectS2CPacket(DisconnectReason reason) {
    this.reason = reason;
  }

  @Override
  public void write(ByteBuf buf) {
    buf.writeInt(reason.getId());
  }
}