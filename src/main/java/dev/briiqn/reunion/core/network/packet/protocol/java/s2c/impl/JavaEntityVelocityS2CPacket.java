...
import dev.briiqn.reunion.core.network.packet.protocol.console.s2c.impl.ConsoleSetEntityMotionS2CPacket;
...
@PacketInfo(side = PacketSide.JAVA_S2C, id = 0x12, supports = {47})
public final class JavaEntityVelocityS2CPacket extends JavaS2CPacket {

  private int entityId;
  private short vx, vy, vz;

  public JavaEntityVelocityS2CPacket() {
  }
  ...
  public void handle(JavaSession session) {
    ...
    PacketManager.sendToConsole(session.getConsoleSession(),
        new ConsoleSetEntityMotionS2CPacket(cid, vx, vy, vz));
  }
}